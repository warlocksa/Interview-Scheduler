...
storiesOf("Appointment", module)
  .addParameters({
    backgrounds: [{ name: "blue", value: "#fff", default: true }]
  })
  ...
  .add("Edit", () => <Form student="Chi" interviewer="1" interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
